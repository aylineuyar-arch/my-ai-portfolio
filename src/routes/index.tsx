        ...
        <div className="mt-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-3 items-stretch">
            {[
              ...
              { num: "No. 02", id: "project-restaurant", title: "Restaurant Reservation Agent — Fork Yea", blurb: "Agentic orchestration with specialized sub-agents — parses, researches, ranks & books.", sub: "LangGraph · Claude · Playwright", tools: ["Cursor", "LangGraph", "Claude", "Playwright", "Tavily", "FastAPI"] },
      ...
      <section id="project-restaurant" className="mx-auto max-w-6xl px-6 py-20 md:py-28 scroll-mt-8">
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-4">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-light leading-tight">
              Restaurant Reservation Agent — Fork Yea
            </h2>
